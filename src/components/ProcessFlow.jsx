...
export const ProcessFlow = () => {
  ...
  }, [isAutoPlay, isHovered, totalSteps]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
              ...
              {PROCESS_STEPS.map((step, idx) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full p-4 sm:p-5 rounded-2xl text-left transition-all border flex items-center justify-between group relative overflow-hidden ${
                      isActive
                  ...
                  >
                    ...
                    {isActive && (
                      <div className="absolute top-0 left-0 bottom-0 w-1 bg-[#E51A4B]"></div>
                    )}
          ...
          <div className="lg:col-span-7 w-full">
            <div className="glass-panel p-5 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl border border-black/10 dark:border-white/15 text-left relative shadow-2xl overflow-hidden">
